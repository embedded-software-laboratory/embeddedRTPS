...
#include <rtps/common/MD5.h>

#include <string.h>
//#include "rtps/commonmd5.h"
...
void rtps::MD5Init (MD5_CTX *context)
{
...
void rtps::MD5Update ( MD5_CTX *context, const uint8_t *input, uint32_t inputLen )
{
...
void rtps::MD5Final ( uint8_t digest[16], MD5_CTX *context )
{
  uint8_t bits[8];
  ...
  rtps::MD5Update (context, PADDING, (uint32_t)padLen);

  // Append length (before padding)
  rtps::MD5Update (context, bits, 8L);
